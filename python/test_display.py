...
try:
    ...
    print(
        "If you can see the test image on your e-Paper display, everything is working."
    )
    print(
        "You can now run the real-time display with: sudo python3 standalone_realtime.py"
    )
