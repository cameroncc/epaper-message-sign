...
class SnoopyImageGallery:
    ...
    def draw_classic_snoopy(self, draw, x, y):
        ...
        body_height = 25
        draw.ellipse(
            [x - body_width // 2, y + 8, x + body_width // 2, y + 8 + body_height],
            fill=255,
            outline=0,
            width=2,
        )
        ...
        collar_y = y + 12
        draw.ellipse(
            [x - body_width // 2 + 2, collar_y, x + body_width // 2 - 2, collar_y + 5],
            fill=0,
            outline=0,
            width=1,
        )
        ...
        arm_y = y + 18
        draw.line(
            [x - body_width // 2, arm_y, x - body_width // 2 - 6, arm_y + 8],
            fill=0,
            width=2,
        )
        draw.line(
    ...
    def draw_dancing_snoopy(self, draw, x, y):
        ...
        draw.line(
            [x + 9, arm_y, x + 9, arm_y - 10], fill=0, width=2
        )  # Raised right arm
            ...
            try:
                ...
                if image:
                    ...
                    if processed_image:
                        ...
                        logging.info(
                            f"Successfully loaded web image: {img_info['name']}"
                        )
