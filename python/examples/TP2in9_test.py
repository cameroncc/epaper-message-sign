...
picdir = os.path.join(
    os.path.dirname(os.path.dirname(os.path.realpath(__file__))), "pic/2in9"
)
    ...
    while 1:
        ...
        if ICNT_Dev.TouchCount:
            ...
            if Page == 1 and ReFlag == 0:  # weather
                if (
                    ICNT_Dev.X[0] > 136
                    and ICNT_Dev.X[0] < 159
                    and ICNT_Dev.Y[0] > 101
                    and ICNT_Dev.Y[0] < 124
                ):
                    print("Home ...\r\n")
                    Page = 0
                    Read_BMP(PagePath[Page], 0, 0)
            ...
            if Page == 2 and ReFlag == 0:  # photo menu
                if (
                    ...
                    Read_BMP(PagePath[Page], 0, 0)
                    Photo_L = (
                        ICNT_Dev.X[0] // 96 + ICNT_Dev.Y[0] // 48 * 3 + Photo_S * 3 + 1
                    )
