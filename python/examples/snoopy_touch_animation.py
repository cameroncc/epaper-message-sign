...
class SnoopyAnimation:
        ...
        for line in lines:
            ...
            for char in line:
                if char != " ":
                    ...
                    draw.rectangle(
                        [x_pos, y_pos, x_pos + char_width - 1, y_pos + char_height - 1],
                        fill=0,
                        outline=0,
                    )
                x_pos += char_width
    ...
    def draw_ui_elements(self, draw):
        ...
        draw.text(
            (5, self.height - 40), "Touch Bottom: Sleep/Wake", font=font_small, fill=0
        )
        draw.text(
            (5, self.height // 2 - 10), "Touch Middle: Happy", font=font_small, fill=0
        )
