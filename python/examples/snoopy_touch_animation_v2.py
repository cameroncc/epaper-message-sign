...
class SnoopyAnimationV2:
    ...
    def draw_snoopy_body(self, draw, x, y, state):
        ...
        if state == "dancing":
            ...
            # Happy arms (up)
            draw.line(
                [x - body_width // 2, y + 5, x - body_width // 2 - 6, y + 5 - 8],
                fill=0,
                width=3,
            )
            draw.line(
            ...
            # Normal arms
            draw.line(
                [x - body_width // 2, y + 5, x - body_width // 2 - 6, y + 5 + 6],
                fill=0,
                width=3,
            )
            draw.line(
            ...
            if size > 0:
                draw.ellipse(
                    [
                        bubble_x + offset,
                        bubble_y - offset,
                        bubble_x + offset + size,
                        bubble_y - offset + size,
                    ],
                    fill=255,
                    outline=0,
                    width=1,
    ...
    def draw_speech_bubble(self, draw, x, y, text):
        ...
        draw.polygon(
            [
                (bubble_x + 5, bubble_y + bubble_height),
    ...
    def draw_ui_elements(self, draw):
        ...
        draw.text(
            (2, self.height - 35), "Touch Bottom: Sleep/Wake", font=font_small, fill=0
        )
        draw.text(
            (2, self.height // 2 - 5), "Touch Middle: Happy", font=font_small, fill=0
        )
